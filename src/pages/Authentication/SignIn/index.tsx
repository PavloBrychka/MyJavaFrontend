...
import {ILogin, ITokenResponse} from "./types.ts";
...
const SignIn = () => {
  ...
  const validator = Yup.object().shape({
    email: Yup.string().required("Вкажіть пошту").email("Не віркно вказано пошту"),
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <GoogleOAuthProvider clientId="1071910169212-bbc704kc5nu1oam8147kkvbkjjfud9mb.apps.googleusercontent.com">
                  <GoogleAuth/>
                </GoogleOAuthProvider>
